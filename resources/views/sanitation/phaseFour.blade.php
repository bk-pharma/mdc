	...
	<div class="row mt-3">
		<div class="col-md">
			...
			<div class="form-group">
				<div id="leftLogsPhaseFour" contenteditable="true" spellcheck="false" v-html="leftLogs" style="overflow-x: scroll; max-height: 300px; background-color:white;">
			    </div>
		...
		<div class="col-md">
			<div id="rightLogsPhaseFour" contenteditable="true" spellcheck="false" v-html="rightLogs" style="overflow-x: scroll; max-height: 300px; background-color:white;">
