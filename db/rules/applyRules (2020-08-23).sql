DELIMITER $$
CREATE PROCEDURE `applyRules`(IN `rawId` VARCHAR(255), IN `rawStatus` VARCHAR(255), IN `mdName` VARCHAR(255), IN `correctedName` VARCHAR(255), IN `universe` VARCHAR(255), IN `mdCode` VARCHAR(255))
BEGIN
